...
export default function Banner() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-purple-100 via-rose-100 to-orange-100">
      <div className="container relative py-12 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-4xl">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-center sm:text-left">
            <Logo className="h-24 w-24 text-primary drop-shadow-lg" />
            <div>
